...
void inRight() { // 오른쪽에 사람 있음
  LED_Fill(0x00);
  LED_P8x16Str(23, 1, "Empty Seat");
  LED_P8x16Str(23, 5, "[O]----[X]");
  delay(2000);
}
void inLeft() { // 왼쪽에 사람 있음
  LED_Fill(0x00);
  LED_P8x16Str(23, 1, "Empty Seat");
  LED_P8x16Str(23, 5, "[X]----[O]");
  delay(2000);
}
void inNothing() { // 둘다 사람 없음
  LED_Fill(0x00);
  LED_P8x16Str(23, 1, "Empty Seat");
  LED_P8x16Str(23, 5, "[O]----[O]");
  delay(2000);
}
void inBoth() { // 둘다 사람 있음
  LED_Fill(0x00);
  LED_P8x16Str(23, 1, "Empty Seat");
  LED_P8x16Str(23, 5, "[X]----[X]");
  delay(2000);
}
void setup()
{
...
void loop()
{
  ...
  LED_P8x16Str(23, 0, "Well come to");
  LED_P8x16Str(40, 3, "Find my");
  LED_P8x16Str(45, 6, "Toilet");
  delay(500);
...
//RFID
  if (mfrc.uid.uidByte[0] == 231 && mfrc.uid.uidByte[1] == 56
    ...
    object.attach(7);
    object.write(0); // set servo to mid-poin
  }
}
